...
if (isset($_SESSION['edit_id_experience'])) {
    $id_experience = $_SESSION['edit_id_experience'];
    unset($_SESSION['edit_id_experience']);
} else {
    // Jika tidak terdapat nilai pada $_SESSION, maka ambil dari URL
    $id_experience = $_GET['id_experience'];
}

$query = mysqli_query($conn, "SELECT * FROM experience WHERE id_experience = '$id_experience' ");
...
<div class="content-wrapper">
    <div class="container my-1">
        <form action="prodit.php" method="post" enctype="multipart/form-data">
            ...
            <input type="text" name="id_experience" id="id_experience" hidden value="<?= $data['id_experience'] ?>">
            <div class="mb-3">
                <label for="experience" class="form-label">Experience</label>
                <input type="text" name="experience" class="form-control"  autocomplete="off" value="<?= $data['experience']; ?>">
            </div>
            <div class="mb-3">
