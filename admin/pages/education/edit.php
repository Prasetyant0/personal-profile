...
if (isset($_SESSION['edit_id_education'])) {
    $id_education = $_SESSION['edit_id_education'];
    unset($_SESSION['edit_id_education']);
} else {
    // Jika tidak terdapat nilai pada $_SESSION, maka ambil dari URL
    $id_education = $_GET['id_education'];
}

$query = mysqli_query($conn, "SELECT * FROM education WHERE id_education = '$id_education' ");
...
<div class="content-wrapper">
    <div class="container my-1">
        <form action="prodit.php" method="post" enctype="multipart/form-data">
            ...
            <input type="text" name="id_education" id="id_education" hidden value="<?= $data['id_education'] ?>">
            <div class="mb-3">
                <label for="education" class="form-label">Education</label>
                <input type="text" name="education" class="form-control"  autocomplete="off" value="<?= $data['education']; ?>">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="tahun_lulus" class="form-control"  value="<?= $data['tahun_lulus']; ?>">
            </div>
            <div class="mb-3">
