...
<div class="content-wrapper">
  ...
  white-space: nowrap; "><?php echo $data['deskripsi'];  ?></td>
                ...
                <td>
                    <a href='edit.php?id_testimonial=<?php echo $data['id_testimonial']; ?>' class="btn btn-success">Edit</a>
                    <a href='hapus.php?id_testimonial=<?php echo $data['id_testimonial']; ?>' class="btn btn-danger" id="hapusbutton">Hapus</a>
                </td>
        </tbody>
    <?php endforeach; ?>
    </table>
